...
# coarse predictor
class Corner_Predictor_coarse(nn.Module):
    """ Corner Predictor module"""

    def __init__(self, inplanes=64, channel=128):
        super(Corner_Predictor_coarse, self).__init__()
        ...
        with torch.no_grad():
            self.output_sz = 16  # same as input feature resolution
...
class Corner_Predictor(nn.Module):
    ...
    # to visualize heatmap for coordinates
