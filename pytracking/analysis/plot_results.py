...
def merge_multiple_runs(eval_data):
    ...
    # ave_success_rate_plot_fps = torch.tensor(eval_data['fps'])
    ...
    for i in range(len(trackers)):
        ...
        # ave_fps_merged.append(ave_success_rate_plot_fps[:, match].mean(0))
    ...
    # ave_fps_merged = torch.stack(ave_fps_merged, dim=1)
    ...
    # eval_data['ave_fps_merged'] = ave_fps_merged.tolist()
