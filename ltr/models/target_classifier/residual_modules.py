...
class LinearFilterLearnGen(nn.Module):
    def __init__(self, feat_stride=16, init_filter_reg=1e-2, init_gauss_sigma=1.0, num_dist_bins=5,
...
class LinearFilterHinge(nn.Module):
    def __init__(self, feat_stride=16, init_filter_reg=1e-2, hinge_threshold=-999, activation_leak=0.0,
                 score_act='bentpar', act_param=None):
        super().__init__()
    ...
    def forward(self, meta_parameter: TensorList, feat, bb=None, train_label=None, sample_weight=None,
                is_distractor=None):
