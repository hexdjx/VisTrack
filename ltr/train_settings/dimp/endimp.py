...
from ltr.models.tracking import endimpnet
...
def run(settings):
    settings.description = 'Enhancing based on SuperDiMP'
    ...
    net = endimpnet.endimpnet50(filter_size=settings.target_filter_sz, backbone_pretrained=True, optim_iter=5,
