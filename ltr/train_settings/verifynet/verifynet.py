...
def run(settings):
    ...
    data_processing_train = processing.VerifyNetProcessing(search_area_factor=settings.search_area_factor,
    ...
    data_processing_val = processing.VerifyNetProcessing(search_area_factor=settings.search_area_factor,
                                                         output_sz=settings.output_sz,
                                                         center_jitter_factor=settings.center_jitter_factor,
                                                         scale_jitter_factor=settings.scale_jitter_factor,
                                                         mode='sequence',
    ...
    trainer.train(50, load_latest=True, fail_safe=False)  # 40
