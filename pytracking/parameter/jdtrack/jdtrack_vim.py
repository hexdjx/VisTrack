...
def parameters():
    ...
    # ------------------------------------------------------------
    # params.use_target_template = True # VimTrack_online_target
    params.use_target_template_fuse = True # VimTrack_online_target_fuse
    # ------------------------------------------------------------

    # VimTrack_online.pth.tar | VimTrack_online_target.pth.tar | VimTrack_online_target_fuse.pth.tar
    params.net = NetWithBackbone(net_path='JDTrack/Vim/VimTrack_online_target_fuse.pth.tar', use_gpu=params.use_gpu)
