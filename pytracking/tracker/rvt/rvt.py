...
class RVT(BaseTracker):
    ...
    def initialize(self, image, info: dict) -> dict:
        ...
        if verifier_flag:
            ...
            self.params.verify_net.initialize()
            self.verify_net = self.params.verify_net
            self.init_target_embedding = self.get_verify_embedding(im)
        ############################################################
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        verifier_flag = self.params.get('verifier_flag', False)
        if verifier_flag:
            new_target_embedding = self.get_verify_embedding(im)
            sim = torch.cosine_similarity(self.init_target_embedding, new_target_embedding)
