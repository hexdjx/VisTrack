...
def run(settings):
    ...
    processing_train = processing.TargetCandiateMatchingProcessing(output_sz=settings.output_sz,
                                                                   train_transform=transform_train,
                                                                   num_target_candidates=5,
                                                                   img_aug_transform=img_aug_transform_train)

    processing_val = processing.TargetCandiateMatchingProcessing(output_sz=settings.output_sz,
                                                                 train_transform=transform_train,
                                                                 num_target_candidates=5,
                                                                 img_aug_transform=img_aug_transform_train)
